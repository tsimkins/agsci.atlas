...
class ICventEvent(ILocationEvent, IAtlasRegistration):
    ...
    def getRestrictedFieldConfig():
        ...
        fields = ['cvent_id', 'cvent_event_code', 'cvent_url', 'cvent_event_format']
    ...
    def getOmittedFieldConfig():
        ...
        # Initialize fields
        fields = ['external_url', 'agenda', 'product_detail', 'price', 'event_when_custom']
    ...
    model.fieldset(
        'internal',
        label=_(u'Internal'),
        fields=('cvent_id', 'cvent_event_code', 'cvent_url', 'cvent_event_format', 'force_recorded_webinar'),
    )
